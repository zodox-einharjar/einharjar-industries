...
_DEFAULTS: dict[str, str] = {
    ...
    "reprocessing_gas_efficiency_pct": "90.0",
...
async def _load_settings() -> dict:
    ...
    for k, v in result.items():
        ...
        elif k == "reprocessing_gas_efficiency_pct":
            out[k] = float(v) if v else 90.0
...
class SettingsUpdate(_Base):
    ...
    reprocessing_gas_efficiency_pct: float | None = None
...
async def update_settings(body: SettingsUpdate):
    ...
    if body.reprocessing_gas_efficiency_pct is not None:
        await _save("reprocessing_gas_efficiency_pct", str(body.reprocessing_gas_efficiency_pct))
